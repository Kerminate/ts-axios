...
describe('helpers:header', () => {
  ...
  describe('processHeaders', () => {
    ...
    test('should set Content-Type if not set and data is a PlainObject', () => {
      const headers: any = {};
      processHeaders(headers, { a: 1 });
      expect(headers['Content-Type']).toBe('application/json;charset=utf-8');
    });

    test('should not set Content-Type if not set and data is not a PlainObject', () => {
      const headers: any = {};
